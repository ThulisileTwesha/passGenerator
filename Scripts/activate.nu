...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Thulisile.Twesha\PycharmProjects\passGenerator'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Thulisile.Twesha\PycharmProjects\passGenerator\Scripts\deactivate.nu'
